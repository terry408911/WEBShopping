...
public class ViewGoodsController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
        ...
        int recordCount=gd.getRecordCount();//总条目数       
        int pagesCount=recordCount%Parameters.pageSize==0?recordCount/Parameters.pageSize:recordCount/Parameters.pageSize+1;   //总页数     
